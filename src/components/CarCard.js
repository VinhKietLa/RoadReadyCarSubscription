  ...
  return (
    <>
      <div className="mx-auto mt-5 flex flex-wrap justify-center mb-10">
        {carData.map((car) => {
          return (
            <div className="max-w-sm bg-neutral-300	shadow-lg rounded-lg overflow-hidden mx-2 mx-auto w-full" key={car.id}>
              <img
              ...
              <div className="p-4 flex justify-evenly items-center">
                <h1 className="text-black text-2xl">Price: £{car.Price}/ per month</h1>
